...
def generate_titles(cue: CueSheet, composers_mode: str) -> tt.Generator[str, None, None]:
    yield ''
...
def generate_output(mode: str, paths_cues: tt.List[PathCue],
                    composers_mode: str) -> tt.Generator[str, None, None]:
...
def main() -> int:
    ...
    parser.add_argument("-m", "--mode", choices=('full', 'titles', 'logs'), default='titles',
                        help="Mode of generation, default=titles")
    parser.add_argument("-c", "--composers", choices=('prepend', 'inside', 'none'),
                        help="Mode of composers generation, default=prepend")
    ...
    for l in generate_output(args.mode, paths_cues, composers_mode=args.composers):
        print(l)
    return 0
